      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/region/Dehradun" className="text-gray-600 hover:text-orange-500">
                  Dehradun
                </Link>
              </li>
              <li>
                <Link href="/region/Haridwar" className="text-gray-600 hover:text-orange-500">
                  Haridwar
                </Link>
              </li>
              <li>
                <Link href="/region/Nainital" className="text-gray-600 hover:text-orange-500">
                  Nainital
                </Link>
              </li>
              <li>
