...
import { useKumaonArticles, } from "@/features/article/hooks"
import SectionHeader from "@/components/molecules/section-header"
import { useKumaonWebStories } from "@/features/web-story/hooks"
...
export default function TopNewsPage() {
  const { data: kumaonNews } = useKumaonArticles()
  const { data: webStories } = useKumaonWebStories()
  ...
  return (
    <>
      <div className="min-h-screen max-w-7xl w-full md:px-8 2xl:px-0 px-4 mx-auto bg-white">
        ...
        <Intro
          title="Kumaon News"
          description="Stay updated with every news from Kumaon region Uttarakhand. From local updates to state-wide headlines, find everything important in one place. Catch fresh stories as they happen and never miss a moment."
          backgroundImage="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&q=80"
        />
        <SectionBreak />

        {/* Featured Articles Grid */}
        <ArticleSecondaryGrid articles={kumaonNews} />
        <SectionBreak />
